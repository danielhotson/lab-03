...
def get_inbox(recipient: str) -> None:
    """
    Prints out all the recieved mail for a specific recipient
...
def get_sent(sender: str) -> None:
    """
    Prints out all the sent mail for a specific sender
...
def get_mail(mail_id: str) -> None:
    """
    Prints out the mail based on a specific mail id
    
    Args:
    	mail_id (str): specific id of a mail
...
def delete_mail(mail_id: str) -> None:
    """
    Deletes a mail and prints a response based on a specific mail id
